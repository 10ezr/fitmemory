...
const DEFAULT_SHORTCUTS = [
  ...
  { text: "Log today's workout", icon: Dumbbell, category: "fitness", usage: 0 },
  { text: "Check my readiness score", icon: Heart, category: "health", usage: 0 },
  { text: "How did I sleep this week?", icon: Brain, category: "sleep", usage: 0 },
...
const CONTEXTUAL_SHORTCUTS = {
  morning: [
    ...
    { text: "What's my readiness score today?", icon: Heart, category: "health" },
...
export default function QuickShortcuts({ onSelectShortcut, className }) {
  ...
  const updateContextualShortcuts = () => {
    ...
    const contextual = CONTEXTUAL_SHORTCUTS[timeOfDay] || CONTEXTUAL_SHORTCUTS.morning
  ...
  const getCategoryColor = (category) => {
    switch (category) {
      case 'sleep': return 'from-blue-50 to-purple-50 dark:from-blue-950/50 dark:to-purple-950/50 border-blue-200/50 dark:border-blue-800/50'
      case 'fitness': return 'from-green-50 to-emerald-50 dark:from-green-950/50 dark:to-emerald-950/50 border-green-200/50 dark:border-green-800/50'
      case 'health': return 'from-orange-50 to-red-50 dark:from-orange-950/50 dark:to-red-950/50 border-orange-200/50 dark:border-orange-800/50'
      default: return 'from-gray-50 to-slate-50 dark:from-gray-950/50 dark:to-slate-950/50 border-gray-200/50 dark:border-gray-800/50'
    }
  }
  ...
  return (
    <div className={`space-y-3 ${className}`}>
      ...
      <div className="text-xs text-muted-foreground text-center">
        Shortcuts adapt based on time of day and your usage patterns
      </div>
    </div>
  )
}